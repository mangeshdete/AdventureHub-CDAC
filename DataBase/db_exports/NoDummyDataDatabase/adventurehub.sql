...
CREATE TABLE `customers` (
  ...
  KEY `state_id_fk` (`stateid`),
  KEY `city_id_fk` (`cityid`),
  CONSTRAINT `city_id_fk` FOREIGN KEY (`cityid`) REFERENCES `cities` (`cityid`),
  CONSTRAINT `state_id_fk` FOREIGN KEY (`stateid`) REFERENCES `states` (`stateid`),
...
CREATE TABLE `organisers` (
  ...
  KEY `org_state_id_fk` (`stateid`),
  KEY `org_city_id_fk` (`cityid`),
  CONSTRAINT `org_city_id_fk` FOREIGN KEY (`cityid`) REFERENCES `cities` (`cityid`),
  CONSTRAINT `org_state_id_fk` FOREIGN KEY (`stateid`) REFERENCES `states` (`stateid`),
...
CREATE TABLE `publishevents` (
  ...
  KEY `publishevent_state_id_fk` (`stateid`),
  ...
  CONSTRAINT `publishevent_state_id_fk` FOREIGN KEY (`stateid`) REFERENCES `states` (`stateid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2024-12-25 20:31:21
