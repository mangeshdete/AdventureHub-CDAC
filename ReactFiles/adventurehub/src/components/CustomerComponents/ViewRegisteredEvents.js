...
function ViewRegisteredEvents() {
    ...
    fetch(`https://localhost:9145/EventRegistration/GetEventRegistrationsByCustId?cid=${user.custid}`) // Replace with actual API endpoint
      ...
      .then((data) => {
        ...
        if(data.length===0){
          ...
          setNoEvents(true); //Reset if events are found
  ...
  return (
    <div className="container mt-5">
      <h2 className="text-center text-primary fw-bold mb-4"></h2>
                    ...
                    <tr className="bg-light">
                      <td colSpan="4">
                        <div className="card shadow-sm border-0 p-3">
                          ...
                          <p className="mb-1">
                            <strong>Date & Time:</strong> {selectedEvent.eventdate},
