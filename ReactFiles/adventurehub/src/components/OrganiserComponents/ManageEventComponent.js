...
//           <div className="update-event-container row">
...
//                     <button type="button" className="btn btn-secondary" onClick={() => setActiveTab("view")}>Cancel</button>
//                   </div>
//                 </form>
//               </div>
//             </div>
...
//               <form>
//                 <div className="form-group">
//                   <label>Reason for Cancellation<span className="text-danger">*</span></label>
//                   <textarea className="form-control" rows="4" placeholder="Enter Cancellation Reason Here" required onChange={(e) => setCancellationReason(e.target.value)}></textarea>
//                 </div>
//                 <div className="form-group form-check">
//                   <input type="checkbox" id="notify" className="form-check-input" />
//                   <label htmlFor="notify" className="form-check-label">Notify Registered Participants</label>
//                 </div>
//                 <div className="d-flex justify-content-between">
//                   <button type="button" className="btn btn-danger" onClick={requestAdminForCancellation} disabled={isCanceling}>
//                     {isCanceling ? "Requesting..." : "Request Cancellation"}
//                   </button>
//                   <button type="button" className="btn btn-secondary" onClick={() => setActiveTab("view")}>Back</button>
//                 </div>
//               </form>
